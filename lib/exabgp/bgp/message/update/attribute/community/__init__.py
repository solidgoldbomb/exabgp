...
from exabgp.bgp.message.update.attribute.community.common import CommonHeader
from exabgp.bgp.message.update.attribute.community.common import CommonHeaders
